...
build:; forge build # Semi Column to do a command on same line via using ":;"

deploy-sepolia: # No same line, no need for ":;"
...
# Toggle Word Wrap = Make all code visible in screen from same line

# Default used bt Collins
